...
Во время сборки Dockerfile устанавливает доступные обновления безопасности
системных пакетов Debian и очищает индекс `apt`, чтобы исправления попадали в
runtime-образ без лишних файлов в итоговом слое.
